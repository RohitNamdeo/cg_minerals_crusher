                               ...
                               // print_r($bill);
                                ...
                                <tr class="<? echo ($bill->status == UNPAID ? "unpaid_bill" : "paid_bill"); ?>" id="bill_<? echo $bill->sales_id; ?>" onclick="show_items(<? echo $bill->sales_id; ?>);" style="cursor: pointer;">
                                    <td align="center" class="action_column">
                                        <?
                                            if($this->outstanding_bill_found == YES)
                                            {
                                    ...
                                    <td align="right">
                                        <?
                                            if($this->outstanding_bill_found == YES)
                                            {
                                                echo round_2dp($bill->amount_paid);
                                            }
                                            else
                                            {
                                                echo round_2dp($bill->total_amount);
                                            }
                                        ?>
                                    </td> 
                                    <td>
                ...
                <table class="clean centreheadings" id="payments">
                    ...
                    <?
                        if(count($this->payments) > 0)
                        {
                            ...
                            {
                                ?>
                                <tr class="payments" id="payment_<? echo $payment->payment_id; ?>" payment_type="<? echo $payment->type; ?>" onclick="highlight_bills(<? echo $payment->payment_id; ?>);" style="cursor:pointer;">
