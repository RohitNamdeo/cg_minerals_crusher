...
class HrViewSalary_report extends JViewLegacy
{
    function display($tpl = null)
    {
        //it shows the salary generated including the advance deducted in salary
        $db = JFactory::getDBO();
        ...
        if (!Functions::has_permissions("hr", "salary_report"))
        {
        ...
        $document->setTitle("Salary Report");
