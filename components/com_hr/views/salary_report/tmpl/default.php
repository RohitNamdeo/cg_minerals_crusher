...
<script>
    ...
    function get_salary()
    {
        ...
        go("index.php?option=com_hr&view=salary_report&month=" + j("#month").val() + "&year=" + j("#year").val() + "&location_id=" + j("#location_id").val() + "&employee_id=" + j("#employee_id").val());
    }
</script>
...
<table>
    <tr>
        ...
        <td>
            ...
            <input type="button" value="Clear" onclick="go('index.php?option=com_hr&view=salary_report');">
        </td>
    </tr>
</table>
<br />
